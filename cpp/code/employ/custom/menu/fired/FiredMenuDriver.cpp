...
#include "FiredMenuDriver.h"
#include "../../controller/amount/AmountController.h"

namespace employ::custom::menu {
    using namespace employ::custom::controller;

    FiredMenuDriver &FiredMenuDriver::display() {
        cout << "FiredMenuDriver::display" << endl;
        displayFireEmployeeMenu.display();
        return *this;
    }

    FiredMenuDriver &FiredMenuDriver::action() {
        cout << "FiredMenuDriver::action" << endl;
